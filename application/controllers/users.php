...
class Users extends CI_Controller{
	...
	public function register(){
		...
		$this->form_validation->set_rules('email', 'Email Address', 'trim|required|min_length[3]');
	...
	public function login(){
		...
		if($this->form_validation->run() == FALSE){
			...
			if($user_id){
				...
				$this->session->set_flashdata('login_failed', 'Username or Password Is Not Valid');
				redirect('home/index');
			}
